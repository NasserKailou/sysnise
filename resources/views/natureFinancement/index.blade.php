    ...
    <div class="row">
      ...
      <div class="col-md-12 col-lg-12">
        <div class="card">
		  <div class="card-header">
			<strong>Nouveau nature de financement</strong>
		  </div>
		  <div class="card-body">
			<form action="{{ route('nature_financements.store') }}" method="POST">
				@csrf
				<div class="row">
					<div class="row mb-3">
						<div class="col-md-12">
	  ...
	  <!-- Tableau des pièces jointes -->
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <strong>Natures de financement</strong>
                </div>
                <div class="card-body">
                    <table class="dataTable table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-left">{{ $nature->intitule }}</td>
                                <td class="text-center table-icons">
                                    <a href="{{ route('nature_financements.edit', $nature->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                    <form action="{{ route('nature_financements.destroy',$nature->id) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
