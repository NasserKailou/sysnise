      ...
      <div class="col-md-12 col-lg-12">
        <div class="card">
		  <div class="card-header">
			<strong>Nouvelle étude</strong>
		  </div>
		  <div class="card-body">
			<form action="{{ route('etudes.store') }}" method="POST">
				@csrf
				<div class="row">
					<div class="row mb-3">
						<div class="col-md-12">
                ...
                <div class="card-body">
                    <table class="dataTable table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-left">{{ $etude->intitule }}</td>
                                <td class="text-center table-icons">
                                    <a href="{{ route('etudes.edit', $etude->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                    <form action="{{ route('etudes.destroy',$etude->id) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
