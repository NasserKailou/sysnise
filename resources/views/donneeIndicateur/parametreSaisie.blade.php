		...
		<div class="row">
			<div class="col-12">
			  <div class="d-flex align-items-center justify-content-between">
				  ...
				  <div class="ml-3">
					<button  id="btn_submit" class="btn btn-sm btn-success waves-effect px-3">
					  Valider
					</button>
				  </div>
				</div>
			...
			$(document).ready(function () {
				...
				/*------------------------------------*/
				  ...
				  $("#btn_submit").click(function(){
						...
						{
							$.post('/donnee_indicateurs/parametreSaisie',{indicateurs:paramIndicateur,periodes:paramPeriode},function(data){
