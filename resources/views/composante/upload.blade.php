		...
		<div class="modal fade" id="myModal" tabindex="-1">
		    ...
		    <div class="modal-content">
			      <div class="modal-header">
			        <h5 class="modal-title" >Import Composantes</h5>
			        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
			          <span aria-hidden="true">&times;</span>
			        </button>
			      </div>
		      <div class="modal-body">
		     	<form  action="{{ route('projets.composantes.upload',$projet->id) }}" method="POST" enctype="multipart/form-data">
					@csrf
					<div class="form-group">
						<input name="projet_id" type="hidden" class="form-control" value="{{ $projet->id }}">
