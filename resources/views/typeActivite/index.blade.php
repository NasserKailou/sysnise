      ...
      <div class="col-md-12 col-lg-12">
        <div class="card">
		  <div class="card-header">
			<strong>Nouveau type activité</strong>
		  </div>
		  <div class="card-body">
			<form action="{{ route('type_activites.store') }}" method="POST">
				@csrf
				<div class="row">
					<div class="row mb-3">
						<div class="col-md-12">
                ...
                <div class="card-body">
                    <table class="dataTable table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-left">{{ $typeActivite->intitule }}</td>
                                <td class="text-center table-icons">
                                    <a href="{{ route('type_activites.edit', $typeActivite->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                    <form action="{{ route('type_activites.destroy',$typeActivite->id) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
