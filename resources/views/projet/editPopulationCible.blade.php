				...
				<div class="row">
					<div class="row mb-3">
						...
						<div class="col-md-6">
						  ...
						  <input name="effectif" type="text" class="form-control" value="{{ old('effectif', $effectif) }}">
						</div>
					</div>
				</div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center table-icons">
                                    ...
                                    <form action="{{ route('projets.populationCibles.destroy',$cible->id) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
