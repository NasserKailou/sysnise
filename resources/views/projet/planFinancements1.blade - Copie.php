                        ...
                        <tbody>
                            ...
                            <tr>
								...
								<td class="text-center table-icons">
                                    <a href="{{ route('projets.planFinancements.budgetAnnuelPrevu', [$projet->id,$financement->pivot->composante->id,$financement->id,$financement->pivot->bailleur->id,$financement->pivot->categorieDepense->id,$financement->pivot->natureFinancement->id,$financement->pivot->statutFinancement->id ]) }}" class="btn btn-sm btn-secondary"><i class="fa fa-edit"></i></a>
									<a href="{{ route('projets.planFinancements.budgetAnnuelPrevu', [$projet->id,$financement->pivot->composante->id,$financement->id,$financement->pivot->bailleur->id,$financement->pivot->categorieDepense->id,$financement->pivot->natureFinancement->id,$financement->pivot->statutFinancement->id ]) }}" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
									<a href="{{ route('projets.planFinancements.budgetAnnuelDepense', [$projet->id,$financement->pivot->composante->id,$financement->id,$financement->pivot->bailleur->id,$financement->pivot->categorieDepense->id,$financement->pivot->natureFinancement->id,$financement->pivot->statutFinancement->id ]) }}" class="btn btn-sm btn-success-subtle"><i class="fa fa-edit"></i></a>
									<a href="{{ route('projets.planFinancements.edit', [$projet->id,$financement->pivot->composante->id,$financement->id,$financement->pivot->bailleur->id,$financement->pivot->categorieDepense->id,$financement->pivot->natureFinancement->id,$financement->pivot->statutFinancement->id ]) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
									<form action="{{ route('projets.planFinancements.destroy',[$projet->id,$financement->pivot->composante->id,$financement->id,$financement->pivot->bailleur->id,$financement->pivot->categorieDepense->id,$financement->pivot->natureFinancement->id,$financement->pivot->statutFinancement->id ]) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
