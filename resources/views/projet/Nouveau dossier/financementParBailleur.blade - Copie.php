                        ...
                        <tbody>
                            ...
                            <tr>
								...
								<td class="text-center table-icons">
                                    <a href="{{ route('projets.financementParBailleur.edit', [$projet->id,$financement?->id]) }}" class="btn btn-sm btn-secondary" data-bs-toggle="tooltip" data-bs-placement="top" title="Modifier"><i class="fa fa-edit"></i></a>
