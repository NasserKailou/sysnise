		  ...
		  <div class="card-body">
			...
			<div class="row">
				...
				<div class="row mb-3">
					...
					<div id="div_date_debut_prevue" class="col-md-3" style="display:none">
					  <label class="form-label">Date de début</label>
					  <input id="date_debut_prevue" name="date_debut_prevue" type="date" class="form-control" onchange="calculerDuree()">
					</div>
					<div id="div_date_fin_prevue" class="col-md-3" style="display:none">
					...
					<!--<div class="col-md-3">
					  <label class="form-label">coût du projet (DEVISE)</label>
					  <input name="cout_devise" type="integer" class="form-control">
					</div>-->
					...
					<div class="execution_projet col-md-6" style="display:none">
