    ...
    <div class="row">
      ...
      <div class="col-md-12 col-lg-12">
        <div class="card">
		  ...
		  <div class="card-body">
			<form action="{{ route('projets.planFinancements.budgetAnnuel.update',['projet' => $projet->id,'budgetAnnuel' => $budgetAnnuel->id ]) }}" method="POST">
				@csrf
				<div class="row">
					<div class="row mb-3">
						<div class="col-md-4">
						   ...
						   <select name="categorie_depense_id" class="form-select @error('categorieDepense') is-invalid @enderror" required>
								...
								@foreach($categorieDepenses as $categorie)
									<option value="{{ $categorie->id }}"
										{{ old('categorie_depense_id', $budgetAnnuel->categorieDepense->id ?? '') == $categorie->id ? 'selected' : '' }}>
										{{ $categorie->intitule }}
									</option>
								@endforeach
							</select>
