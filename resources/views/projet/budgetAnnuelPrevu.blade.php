    ...
    <div class="row">
      ...
      <div class="col-md-12 col-lg-12">
        <div class="card">
		  ...
		  <div class="card-body">
			<form action="{{ route('projets.planFinancements.budgetAnnuelPrevu.store',['projet' => $projet->id,'planFinancement' => $planFinancement->id ]) }}" method="POST">
				@csrf
				<div class="row">
					<div class="row mb-3">
						<div class="col-md-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center table-icons">
                                    <a href="{{ route('projets.planFinancements.budgetAnnuelPrevu.edit', [$projet->id, $budget->id]) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                    <form action="{{ route('projets.planFinancements.budgetAnnuelPrevu.destroy', [$projet->id, $budget->id]) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
