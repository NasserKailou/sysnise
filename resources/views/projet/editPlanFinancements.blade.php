    ...
    <div class="row">
      ...
      <div class="col-md-12 col-lg-12">
        <div class="card">
		  ...
		  <div class="card-body">
			<form action="{{ route('projets.planFinancements.update',['projet' => $projet->id,'sourceFinancement'=> $sourceFinancementId,'bailleur'=> $bailleurId,'statutFinancement'=> $statutFinancementId ,'natureFinancement'=> $natureFinancementId,]) }}" method="POST">
				@csrf
				<div class="row">
					<div class="row mb-3">
						<div class="col-md-6">
						   ...
						   <select name="composante_id" class="form-select @error('composante') is-invalid @enderror">
								...
								@foreach($composantes as $composante)
									<option value="{{ $composante->id }}"
										{{ old('composante_id', $composanteId ?? '') == $composante->id ? 'selected' : '' }}>
										{{ $statut->intitule }}
									</option>
								@endforeach
							</select>
