    ...
    <div class="row">
      ...
      <div class="col-md-12 col-lg-12">
        <div class="card">
		  ...
		  <div class="card-body">
			<form action="{{ route('projets.planFinancements.budgetAnnuelDepense.update',['projet' => $projet->id,'budgetAnnuelDepense' => $budgetAnnuelDepense->id ]) }}" method="POST">
				@csrf
				<div class="row">
					<div class="row mb-3">
						<div class="col-md-4">
						...
						<div class="col-md-4">
						  ...
						  <input name="annee" type="text" class="form-control" value="{{ old('annee', $budgetAnnuelDepense->annee) }}" required>
						</div>
						<div class="col-md-4">
						  <label class="form-label">Montant 
							<span style="color: red;">*</span>
						  </label>
						  <input name="montant" type="text" class="form-control" value="{{ old('montant', $budgetAnnuelDepense->montant) }}" required>
						</div>
					</div>
				</div>
