		  ...
		  <div class="card-body">
			...
			<div class="row">
				...
				<div class="row mb-3">
					...
					<div  class="execution_projet col-md-3 mt-3" class="d-none dynamic-field">
					...
					<div  class="execution_projet col-md-3" class="d-none dynamic-field">
					  ...
					  <input name="date_demarrage_effectif" type="date" class="form-control">
					</div>
					<div class="col-md-3">
					...
					<div class="execution_projet col-md-4 mt-3" class="d-none dynamic-field">
...
$(document).ready(function() {
	...
	$('#statut_projet_id').change(function () {
		...
		$('#div_annee_demarrage').addClass('d-none');
		$('#div_date_debut_prevue').addClass('d-none');
		$('#div_date_fin_prevue').addClass('d-none');
		$('.execution_projet').addClass('d-none');

		if ($(this).val() == 1) {

			$('#div_annee_demarrage').removeClass('d-none');

		} else if ($(this).val() == 2) {

			$('#div_date_debut_prevue').removeClass('d-none');
			$('#div_date_fin_prevue').removeClass('d-none');

		} else if ($(this).val() == 3) {

			$('.execution_projet').removeClass('d-none');
