...
<div class="container py-4" x-data="{
        sessionModalAction: '',
        sessionRecoModalAction: '',
        auditExerciceModalAction: '',
        auditRecoModalAction: '',
        solutionModalAction: '',
    }">

    <h1 class="h3 mb-4">Gouvernance du projet : {{ $projet->name ?? $projet->nom ?? $projet->id }}</h1>
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <button type="button" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#sessionModal"
                    @click="sessionModalAction = '{{ route('projets.governance.sessions.store', $projet) }}'">
                + Ajouter une session
            </button>
        </div>
        <div class="card-body">
            ...
            @forelse (optional($pilotage)->sessions ?? [] as $session)
                <div class="border rounded p-3 mb-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#sessionRecoModal"
                                    @click="sessionRecoModalAction = '{{ route('projets.governance.sessions.recommandations.store', [$projet, $session]) }}'">
                                + Recommandation
                            </button>
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <button type="button" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#auditExerciceModal"
                    @click="auditExerciceModalAction = '{{ route('projets.governance.audit.exercices.store', $projet) }}'">
            ...
            @forelse (optional($audit)->exercices ?? [] as $exercice)
                <div class="border rounded p-3 mb-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#auditRecoModal"
                                    @click="auditRecoModalAction = '{{ route('projets.governance.audit.recommandations.store', [$projet, $exercice]) }}'">
                                + Recommandation
                            </button>
            ...
            @forelse ($problemes as $probleme)
                <div class="border rounded p-3 mb-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#solutionModal"
                                    @click="solutionModalAction = '{{ route('projets.governance.problemes.solutions.store', [$projet, $probleme]) }}'">
                                + Solution
                            </button>
    ...
    {{-- Modale : recommandation de session --}}
    <div class="modal fade" id="sessionRecoModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" :action="sessionRecoModalAction">
                    @csrf
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-check mt-2">
                            <input type="checkbox" name="est_realisee" value="1" class="form-check-input" id="sessionRecoRealisee">
                            <label class="form-check-label" for="sessionRecoRealisee">Déjà réalisée</label>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
    ...
    {{-- Modale : recommandation d'audit --}}
    <div class="modal fade" id="auditRecoModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" :action="auditRecoModalAction">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title">Ajouter une recommandation</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    ...
                    <div class="modal-body">
                        ...
                        <textarea name="libelle" class="form-control" rows="3" required></textarea>
                        <div class="form-check mt-2">
                            <input type="checkbox" name="est_realisee" value="1" class="form-check-input" id="auditRecoRealisee">
                            <label class="form-check-label" for="auditRecoRealisee">Déjà réalisée</label>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
    ...
    {{-- Modale : nouvelle solution --}}
    <div class="modal fade" id="solutionModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" :action="solutionModalAction">
                    @csrf
                    <div class="modal-header">
