    ...
    <div class="row">
      ...
      <div class="col-md-12 col-lg-12">
        <div class="card">
		  <div class="card-header">
			<strong>Nouveau statut de financement</strong>
		  </div>
		  <div class="card-body">
			<form action="{{ route('statut_financements.store') }}" method="POST">
				@csrf
				<div class="row">
					<div class="row mb-3">
						<div class="col-md-12">
	  ...
	  <!-- Tableau des pièces jointes -->
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <strong>Statuts de financement</strong>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center table-icons">
                                    <a href="{{ route('statut_financements.edit', $statut->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                    <form action="{{ route('statut_financements.destroy',$statut->id) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
