      ...
      <div class="col-md-12 col-lg-12">
        <div class="card">
		  <div class="card-header">
			<strong>Nouvelle source de financement</strong>
		  </div>
		  <div class="card-body">
			<form action="{{ route('source_financements.store') }}" method="POST">
				@csrf
				<div class="row">
					<div class="row mb-3">
						<div class="col-md-12">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center table-icons">
                                    <a href="{{ route('source_financements.edit', $source->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                    <form action="{{ route('source_financements.destroy',$source->id) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
