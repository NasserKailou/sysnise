    ...
    <div class="row">
      ...
      <div class="col-md-12 col-lg-12">
        <div class="card">
		  ...
		  <div class="card-body">
			<form action="{{ route('cadre_logiques.produits.store', $cadre_logique->id) }}" method="POST">
				@csrf
				<div class="row">
					<div class="row mb-3">
						<div class="col-md-4">
                ...
                <div class="card-body">
                    <table class="dataTable table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-left">{{ $produit->intitule }}</td>
								<td class="text-left">{{ $produit->annee_debut_prevu }}</td>
								<td class="text-left">{{ $produit->annee_fin_prevu }}</td>
								<td class="text-left">{{ $produit->duree_travaux }}</td>
								<td class="text-left">{{ $produit->cout_prevu }}</td>
                                <td class="text-center table-icons">
                                    <a href="{{ route('cadre_logiques.produits.show',[$cadre_logique->id, $produit->id]) }}" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Voir les détails"><i class="fa fa-eye"></i></a>
									<a href="{{ route('cadre_logiques.produits.edit',[$cadre_logique->id, $produit->id]) }}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Modifier"><i class="fa fa-edit"></i></a>
                                    <form action="{{ route('cadre_logiques.produits.destroy',[$cadre_logique->id, $produit->id]) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
