                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center table-icons">
                                    <a href="{{ route('cadre_developpements.financementParBailleur.montantConsomme.edit', [$cadreDeveloppement->id, $montantConsomme->id]) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                    <form action="{{ route('cadre_developpements.financementParBailleur.montantConsomme.destroy', [$cadreDeveloppement->id, $montantConsomme->id]) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
