    ...
    <div class="row">
      ...
      <div class="col-md-12 col-lg-12">
        <div class="card">
		  <div class="card-header">
			<strong>Montant consommé [ {{ $financementParResultat->cadreLogique->intitule }}]</strong>
		  </div>
		  <div class="card-body">
	  ...
	  <!-- Tableau des pièces jointes -->
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <strong>Montants mobilisés par an [ {{ $financementParResultat->cadreLogique->intitule }}]</strong>
                </div>
                <div class="card-body">
