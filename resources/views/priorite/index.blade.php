                ...
                <div class="card-body">
                    <table class="dataTable table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-left">{{ $priorite->intitule }}</td>
                                <td class="text-center table-icons">
                                    <a href="{{ route('priorites.edit', $priorite->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                    <form action="{{ route('priorites.destroy',$priorite->id) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
