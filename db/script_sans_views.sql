...
(
    ...
    created_at timestamp DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT projet_financement_pkey PRIMARY KEY (id),
    CONSTRAINT projet_financement_nature_financement_id_fkey FOREIGN KEY (nature_financement_id)
        REFERENCES nature_financements (id) MATCH SIMPLE
        ON UPDATE CASCADE
        ON DELETE CASCADE,
    CONSTRAINT projet_financement_projet_id_fkey FOREIGN KEY (projet_id)
        REFERENCES projets (id) MATCH SIMPLE
        ON UPDATE CASCADE
        ON DELETE CASCADE,
    CONSTRAINT projet_financement_bailleur_id_fkey FOREIGN KEY (bailleur_id)
        REFERENCES bailleurs (id) MATCH SIMPLE
        ON UPDATE CASCADE
        ON DELETE CASCADE,
    CONSTRAINT projet_financement_source_financement_id_fkey FOREIGN KEY (source_financement_id)
        REFERENCES source_financements (id) MATCH SIMPLE
        ON UPDATE CASCADE
        ON DELETE CASCADE,
    CONSTRAINT projet_financement_statut_financement_id_fkey FOREIGN KEY (statut_financement_id)
